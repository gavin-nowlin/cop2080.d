...
#     # Create a single subplot for the RT60 plot
#     # fig, ax = plt.subplots(figsize=(10, 6))

#     # Calculate and plot RT60 for each frequency
#     for frequency in frequencies:
#         rt60_data = calculate_rt60(file_path, frequency, color_map[frequency])
#         plt.plot(rt60_data, label=f"{frequency} Hz", color=color_map[frequency])

#     # Set labels and title
#     plt.set_xlabel("Time (s)")
#     plt.set_ylabel("RT60 (s)")
#     plt.set_title("RT60 for Different Frequencies")
#     plt.legend()
...
def plot_all_rt60s(file_path):
    ...
    combine_rt60s(file_path, frequencies)
